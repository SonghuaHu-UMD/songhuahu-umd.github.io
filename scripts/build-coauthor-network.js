...
(async () => {
  ...
  const STOP = new Set((
    ...
    + 'contiguous united states country countries nation nations american america region regional county counties state states city cities place places location locations'
  ).split(/\s+/));
