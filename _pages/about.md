...
Each panel below summarizes the most distinctive terms in my research for a two-year period. Abstracts are pulled from <a href="https://openalex.org/">OpenAlex</a>. The arc starts with <em>shared mobility</em> and <em>urban flood resilience</em> at Tongji (2017–18), shifts to <em>mobile-device-derived human mobility</em> during COVID-19 at UMD (2019–22), broadens into <em>travel demand modeling</em> and <em>health disparity</em> (2023–24), and most recently combines <em>data-driven traffic emissions</em> with <em>crowdsourced public perception sensing</em> at MIT (2025–26).
</p>
